...
# Merefleksikan titik-titik terhadap sumbu x, y, garis y=x, y=-x, atau titik sesuai dengan parameter
    if param == "x":
        tfMat = np.array([
                [1, 0, 0],
                [0, -1, 0],
...
# Melakukan operasi shear terhadap titik-titik sesuai dengan parameter
    if param == 'x':
        tfMat = np.array([
                [1, k, 0],
                [0, 1, 0],
...
# Mengalikan titik-titik dengan matriks transformasi custom
    tfMat = np.array([
            [a, b, 0],
            [c, d, 0],
            [0, 0, 1]
...
# Melakukan operasi stretch terhadap titik-titik sebesar k terhadap sumbu param
    if param == 'x':
        tfMat = np.array([
                [k, 0, 0],
                [0, 1, 0],
...
#Melakukan translasi atau menggeser titik-titik
    tfMat = np.array([
            [1, 0, dx],
            [0, 1, dy],
            [0, 0, 1]
...
# Melakukan operasi dilatasi terhadap titik-titik sebesar k
    tfMat = np.array([
            [k, 0, 0],
            [0, k, 0],
            [0, 0, 1]
...
# Melakukan rotasi seluruh titik-titik terhadap suatu titik lainnya sebesar degree derajat
    translateToZeroMat = np.array([
            [1, 0, -x],
            [0, 1, -y],
            [0, 0, 1]
...
# Mengganti titik-titik yang lama menjadi titik-titik  yang sudah dikalikan dengan tfMat
...
# Merefleksikan titik-titik terhadap sumbu x, y, atau z, bidang x,y,z atau custom yang melewati titik origin
# ,atau sebuah titik lainnya sesuai dengan parameter
    if param == "x":
        tfMat = np.array([
            [1, 0,0,0],
            [0, -1,0,0],
...
# Melakukan rotasi seluruh titik-titik terhadap suatu sumbu sebesar degree derajat
    panjangVektor = np.sqrt(a*a+b*b+c*c)
    a /= panjangVektor
    b /= panjangVektor
    c /= panjangVektor
